...
const values = [
    {
        title: "QUALITY",
        description: "We maintain the highest standards in every product we deliver, ensuring excellence from source to destination.",
        icon: (
    ...
    {
        title: "INTEGRITY",
        description: "Building trust through honesty, transparency, and ethical business practices in all our global operations.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
        ...
        description: "Committed to sustainable sourcing and environmental stewardship to protect our planet for future generations.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
        title: "INNOVATION",
        description: "Continuously evolving our methods and technologies to provide smarter, more efficient solutions for our partners.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
        title: "COLLABORATION",
        description: "Fostering long-term partnerships built on mutual growth, shared goals, and collaborative success.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function CompanyValues() {
    ...
    return (
        <section className="py-14 bg-transparent overflow-hidden relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                    {values.map((value, index) => (
                        <div 
                            ...
                            className="group p-8 rounded-3xl transition-all duration-500 shadow-lg hover:shadow-2xl hover:-translate-y-2 border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50"
                        >
                            <div className={`${value.color} w-20 h-20 rounded-2xl flex items-center justify-center text-white mb-8 transform transition-transform duration-500 group-hover:rotate-6 shadow-lg`}>
                                {value.icon}
                            </div>
